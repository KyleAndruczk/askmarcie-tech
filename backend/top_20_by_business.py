...
def find_common_food_phrases(file_path, business_id):
    """
    ...
    data = [line for line in data if line["business_id"] == business_id]
    print(data[0])
    data = data[0]["reviews"]
    # data = data[:15000]
...
file_path = 'yelp_combined.json'
common_phrases = find_common_food_phrases(file_path,"CF33F8-E6oudUQ46HnavjQ")
